---
title: "KVKK Uyumlu Müşteri Verisi Saklama: Pratik Rehber 2026"
slug: "kvkk-musteri-verisi-rehberi"
category: "otomasyon"
description: "KVKK uyumlu müşteri verisi saklama rehberi. 7 ilke, VERBİS kayıt, açık rıza vs aydınlatma metni, web sitesi checklist, 2025 ceza tutarları."
keywords: ["kvkk uyumlu", "kvkk müşteri verisi", "kvkk rehberi", "verbis kayıt", "kvkk aydınlatma metni", "kvkk açık rıza"]
publishedAt: "2026-06-21"
author: "Arda Kaya"
readingTime: "12 dakika"
relatedServices: ["otomasyon"]
ogImage: "/blog/og/kvkk-musteri-verisi-rehberi.png"
---
...
Kayıt **ücretsiz**, [verbis.kvkk.gov.tr](https://verbis.kvkk.gov.tr) üzerinden 30-60 dakikada yapılır.
...
**Yasal yollar:**
1. **Müşteri size yazdı** → Bu zaten ilişkili — yanıt verebilirsiniz
2. **Müşteri kayıt sırasında "WhatsApp bilgilendirme" onayı verdi** → İstediğiniz mesajı atabilirsiniz
3. **Müşteri açık olarak abone olmadı** → Pazarlama mesajı atılamaz, sadece sipariş onayı / kargo bildirimi gibi "utility" mesajlar atılabilir
...
[WhatsApp Business API kurulum rehberimiz](/blog/whatsapp-business-api-kurulum) bu konuyu teknik tarafıyla anlatıyor.
...
Kurulum öncesi avukat görüşmesi gerekirse partner avukat ağımız var. Detaylı paketler için [CRM Otomasyonu](/crm-otomasyonu) ve sektörel sayfalar için [CRM Otomasyonu + Klinik](/crm-otomasyonu/klinik), [CRM Otomasyonu + Avukat](/crm-otomasyonu/avukat) sayfalarımıza bakabilirsiniz.

**Ücretsiz keşif görüşmesi:** [portzenai.com/iletisim](https://portzenai.com/iletisim) — 15 dakikada işletmeniz için uygun KVKK uyumlu sistem yapısını birlikte belirleyelim.
